...
<head>
  <meta charset="UTF-8">
  <title>League of Angels Ⅱ test server</title>
  ...
  var __payInfo = new Array();
    __payInfo['1001'] = {'diamond' : 40, 'price' : 100, 'name' : '40ダイヤ'};
    __payInfo['1002'] = {'diamond' : 200, 'price' : 500, 'name' : '200ダイヤ'};
    __payInfo['1003'] = {'diamond' : 400, 'price' : 1000, 'name' : '400ダイヤ'};
    __payInfo['1004'] = {'diamond' : 1236, 'price' : 3000, 'name' : '1236ダイヤ'};
    __payInfo['1005'] = {'diamond' : 2080, 'price' : 5000, 'name' : '2080ダイヤ'};
    __payInfo['1006'] = {'diamond' : 4200, 'price' : 10000, 'name' : '4200ダイヤ'};
    __payInfo['1007'] = {'diamond' : 12720, 'price' : 30000, 'name' : '12720ダイヤ'};
    __payInfo['1008'] = {'diamond' : 21400, 'price' : 50000, 'name' : '21400ダイヤ'};
    </script>
  <style>
    html, body {
      margin: 0;
...
<div id="playArea" name="playArea">
  <iframe id="gameFrame" src="http://s0-loa2.loas.jp:4007/" scrolling="no" frameborder="0" border="0" style="height:100%;width:100%;">loa2</iframe>
</div>
